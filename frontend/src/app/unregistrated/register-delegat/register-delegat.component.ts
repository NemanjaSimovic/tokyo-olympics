...
@Component({
  selector: 'app-register-delegat',
  templateUrl: './register-delegat.component.html',
  styleUrls: ['./register-delegat.component.css']
})
export class RegisterDelegatComponent implements OnInit {
  ...
  onRegister(form: NgForm){
    ...
    if(!(pass.match(regexPatern1) || pass.match(regexPatern2))) {
      this.message = "Password mora sadrzati najmanje 3 mala slovo, 1 veliko slovo, 2 broja i 2 specijalna karaktera. Sifra mora biti duzine 8-12! ";
      this.message2 = "";
      return;
    }
